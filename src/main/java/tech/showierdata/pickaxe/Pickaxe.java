...
import tech.showierdata.pickaxe.features.render.BossBar;
...
public class Pickaxe implements ModInitializer {
	...
	public static boolean buttonHasText(@NotNull ClickableWidget button, @SuppressWarnings("SameParameterValue") String translationKey) {
	...
	private void register_callbacks() {
		...
		ClientTickEvents.END_CLIENT_TICK.register(client -> {
			...
			BossBar.instance.run(MinecraftClient.getInstance());
		...
		RenderCallbacks.instance.register();
